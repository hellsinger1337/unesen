            ...
            <table class="table-auto w-full">
                ...
                @foreach($orders as $order)
                    <tr class="border-b">
                        ...
                        <td class="py-1 px-2 whitespace-nowrap">{{ $order->created_at->format('d-m-Y') }}</td>
                        <td class="py-1 px-2">
                        ...
                        <td class="py-1 px-2 flex gap-2 w-[100px]">
                            @if (!$order->isPaid())
                                <a href="https://t.me/MaximKazakov"
